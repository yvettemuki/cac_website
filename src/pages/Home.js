...
import {Navbar, Jumbotron, Nav, Container, Row, Col, Card, Button} from 'react-bootstrap';
...
class Home extends Component {
    render() {
      return(
        <div className="home">
          <Navbar bg="transparents" variant="dark" Style="border-radius:0">
          ...
          <div className="home-contain">
            ...
            <Col className="course-model">
              ...
              <Row className="course-model-content">
                <Col lg="4" Style="color:#000000;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum</Col>
                <Col lg="8" Style="text-align:right;">
            ...
            <Col className="sub-brand">
              ...
              <Row className = "sub-brand-content">
                <Col md lg="3" className="  sub-brand-col">
